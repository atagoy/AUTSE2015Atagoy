...
if ( function_exists('register_sidebar') )
	register_sidebar(array(
		'name' => __('Left Sidebar','theme1065'),
...
// Search
	function widget_theme1065_search() {
?>
	<div id="search" class="widget widget_search">
		<div class="widget-bg"><div class="indent">
				
			<div class="title">
				<h2><?php _e('Site Search','theme1065'); ?></h2>
			</div>
		
			<div class="indent-col">
                <form method="get" id="searchform" action="<?php bloginfo('home'); ?>">	
                    <input type="text" class="text" value="<?php the_search_query(); ?>" name="s" id="s" />&nbsp;<input class="but" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/submit.png" value="submit" />
                </form>
            </div>
...
if ( function_exists('register_sidebar_widget') )
	register_sidebar_widget(__('Search'), 'widget_theme1065_search');
?>
<?php
