				...
				<div class="wrapper grid-block">
					...
					<header id="header" class="grid-block">
						...
						<div id="headerbar" class="grid-block">
							...
							<?php if($this['modules']->count('headerbar-l')) : ?>
							<div class="float-left"><?php echo $this['modules']->render('headerbar-l'); ?></div>
							<?php endif; ?>
							
							<?php if($this['modules']->count('headerbar-r')) : ?>
							<div class="float-right"><?php echo $this['modules']->render('headerbar-r'); ?></div>
							<?php endif; ?>
