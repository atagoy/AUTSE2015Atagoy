...
~Changelog:
R1.4 (17-July-2007)
Rob at http://robsnotebook.com
Fixed Plugin URI and author URI since I didn't realize these URLS are
listed in the plugin administration page.

R1.3 (10-July-2007)
Rob at http://robsnotebook.com
See http://robsnotebook.com/the-excerpt-reloaded
Thanks to the comment from Hillary Melville, I changed this:
...
R1.2 (6-June-2007)
Rob at http://robsnotebook.com
See http://robsnotebook.com/the-excerpt-reloaded2
Fixed issue where balanceTags() function was only getting called when
$fix_tags==0 instead of 1, and also when it is called, set the 2nd parameter
$force to "true" to make sure the tags are balanced.

R1.1 (2-June-2007)
Rob at http://robsnotebook.com
See http://robsnotebook.com/the-excerpt-reloaded
Fixed issue where invalid XHTML is created because a <p> tag is not closed
with a </p> tag.  Also fixed issue with $fix_tags not getting passed from
the_excerpt_reloaded() to get_the_excerpt_reloaded().
