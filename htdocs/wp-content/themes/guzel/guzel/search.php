...
<div id="bigcolumn">
	...
	<div class="info">Размещено в рубрике: <?php the_category(', ') ?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">Читать полностью</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php the_permalink() ?>#commenting" title="прокомментировать"><?php comments_number('0 коммент.','1 коммент.','% коммент.'); ?></a></div>
