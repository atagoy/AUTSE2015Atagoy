...
$options = array (
	...
	array(	"name" => "Изображение логотипа",
     ...
     array(	"name" => "Активировать раздел 'О сайте'?",
			"desc" => "Снимите флажок, если не хотите активировать этот раздел.",
			"id" => $shortname."_about_bar",
			"std" => "true",
			"type" => "checkbox"),
            
        array(	"name" => "Изображение для раздела 'О сайте'",
		"desc" => "Введите путь к изображению. Оставьте пустым, если не хотите использовать изображение. Рекомендуемые размеры изображения: Ширина: <b>610 px</b>. Высота: <b>300 px.</b>",
		"id" => $shortname."_about_image",
		"std" =>  get_bloginfo('template_url') . "/images/about_image.jpg",
		"type" => "text"),
        
        array(	"name" => "Текст для раздела 'О сайте'",
		"desc" => "",
        "id" => $shortname."_about_content",
        "type" => "textarea",
		"std" => '<h3>Добро пожаловать на наш сайт!</h3>
<p>
...
http://newwpthemes.com/hosting/wpwh12.gif, http://newwpthemes.com/hosting/wpwebhost.php'
	...
	array(	"name" => "Текст для Twitter",
			...
			"std" => "Следуй за мной",
			"type" => "text"),		array(	"name" => "Rss",
			"desc" => "Показывать подписку на RSS над сайдбаром(ами)?",
			"id" => $shortname."_rssbox",
			"std" => "true",
			"type" => "checkbox"),
						
	array(	"name" => "Текст Rss подписки",
			"desc" => "Если активирована Rss, то введите ее текст здесь.",
			"id" => $shortname."_rssboxtext",
			"std" => "Подпишись на RSS!",
			"type" => "text"),
			...
			"std" => "true",
			"type" => "checkbox"),  
				array(	"name" => "Нижний баннер сайдбара №1.",
