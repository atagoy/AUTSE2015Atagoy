<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( is_singular( get_post_type() ) ) : // If viewing a single post. ?>
		...
		<footer class="entry-footer">
			<?php hybrid_post_terms( array( 'taxonomy' => 'category', 'text' => __( 'Posted in %s', 'inception' ) ) ); ?>
			<?php hybrid_post_terms( array( 'taxonomy' => 'post_tag', 'text' => __( 'Tagged %s', 'inception' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
