...
if ($this['config']->get('footer')) $this['asset']->addFile('css', 'css:footer.css');
...
$fonts = array(
	...
	'exo' => 'template:fonts/exo.css',
	'kreon' => 'template:fonts/kreon.css',
	'mavenpro' => 'template:fonts/mavenpro.css',
	'yanonekaffeesatzthin' => 'template:fonts/yanonekaffeesatzthin.css',
...
$body_classes .= $this['modules']->count('top-a') ? 'has-top-a ' : 'no-top-a';
