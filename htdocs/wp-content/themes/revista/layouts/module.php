...
if (($this['config']->get('wrapper-top-a') && ($module->position == 'top-a'))
	|| ($this['config']->get('wrapper-top-b') && ($module->position == 'top-b'))
	|| ($this['config']->get('wrapper-bottom-a') && ($module->position == 'bottom-a'))
	|| ($this['config']->get('wrapper-bottom-b') && ($module->position == 'bottom-b'))
	|| ($this['config']->get('wrapper-bottom-c') && ($module->position == 'bottom-c'))) {
	$template = 'default-1';
	$style = 'mod-line';
}
