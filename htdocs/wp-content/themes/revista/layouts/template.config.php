...
if ($this['config']->get('corners')) $this['asset']->addFile('css', 'css:corners.css');
...
if ($this['config']->get('direction') == 'rtl') {
	...
	if (($corners = $this['config']->get('corners')) && $this['path']->path("css:$corners-rtl.css")) { $this['asset']->addFile('css', "css:$corners-rtl.css"); }
}
...
$fonts = array(
	...
	'fjordone' => 'template:fonts/fjordone.css',
...
$body_classes .= ' '.'wrapper-'.$this['config']->get('wrapper_layout');
