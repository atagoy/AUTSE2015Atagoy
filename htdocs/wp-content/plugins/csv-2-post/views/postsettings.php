    ...
    */
    public function postbox_postsettings_databasedoptions( $data, $box ) {    
        ...
        <table class="form-table">    
            ...
            $this->UI->option_projectcolumns( __( 'Tags' ), $csv2post_settings['currentproject'], 'tags', 'tags', $tags_table, $tags_column, 'notrequired', 'Not Required' );
            ...
            $this->UI->option_projectcolumns( __( 'Featured Images' ), $csv2post_settings['currentproject'], 'featuredimage', 'featuredimage', $featuredimage_table, $featuredimage_column, 'notrequired', 'Not Required' );
            ...
            $this->UI->option_projectcolumns( __( 'Permalink Column' ), $csv2post_settings['currentproject'], 'permalink', 'permalink', $permalink_table, $permalink_column, 'notrequired', 'Not Required' );
            ...
            $this->UI->option_projectcolumns( __( 'URL Cloak 1' ), $csv2post_settings['currentproject'], 'urlcloak1', 'urlcloak1', $urlcloak1_table, $urlcloak1_column, 'notrequired', 'Not Required' );
            ?>    
        </table>
    ...
    public function postbox_postsettings_authoroptions( $data, $box ) {    
        ...
        ?>  
           ...
           <table class="form-table">    
            ...
            $this->UI->option_projectcolumns( __( 'Email Address Data' ), $csv2post_settings['currentproject'], 'email', 'email', $email_table, $email_column, 'notrequired', 'Not Required' );
            ...
            $this->UI->option_projectcolumns( __( 'Username Data' ), $csv2post_settings['currentproject'], 'username', 'username', $username_table, $username_column, 'notrequired', 'Not Required' );
    ...
    public function postbox_postsettings_defaulttagrules( $data, $box ) {    
        ...
        ?>  
           ...
           <table class="form-table">    
            ...
            $this->UI->option_projectcolumns( __( 'Text Data' ), $csv2post_settings['currentproject'], 'generatetags', 'generatetags', $generatetags_table, $generatetags_column, 'notrequired', 'Not Required' );
