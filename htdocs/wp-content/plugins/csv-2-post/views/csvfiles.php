...
class CSV2POST_Csvfiles_View extends CSV2POST_View {
    ...
    */
    public function datatables( $data, $box ) { 
        ...
        $WPTableObject = new C2P_CSVFiles_Table();
...
class C2P_CSVFiles_Table extends WP_List_Table {
