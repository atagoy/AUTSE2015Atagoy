<?php
/**
 * History of data changes i.e. new files detected, file change detected, imports and updates
 *
 * @package CSV 2 POST
 * @subpackage Views
 * @author Ryan Bayne   
...
class CSV2POST_Datahistory_View extends CSV2POST_View {
    ...
    protected $view_name = 'datahistory';
    ...
    * @version 1.1
    */
    public function postbox_csvfiles_datasourcestable( $data, $box ) { 
    ...
    */
    public function datatables( $data, $box ) { 
        ...
        $query_results = $this->CSV2POST->getlog( '*', 'category = "dataevent"' );
                     
        $WPTableObject = new C2P_Datahistory_Table();
...
class C2P_Datahistory_Table extends WP_List_Table {
