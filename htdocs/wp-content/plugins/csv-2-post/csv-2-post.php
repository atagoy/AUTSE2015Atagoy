...
1. shortcode for adding values to any page
2. data history
3. data alerts
4. Current Project: checklist of features in-use or not in use, 
*/           
...
// package variables
$csv2post_filesversion = '8.2.0';# to be removed, version is now in the CSV2POST() class 
